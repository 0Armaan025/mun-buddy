            ...
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="#"
                  style={{ fontFamily: "Poppins" }}
                  className="block py-2 px-3 text-white text-lg"
                >
                  About
                </a>
              </li>
              <li>
                <input
                  type="button"
                  value="Dashboard"
                  className="block py-2 px-3 hover:cursor-pointer transition-all hover:bg-opacity-35 border-blue-300 border-2 w-44 bg-blue-600 bg-opacity-50 rounded text-white text-bold"
                  style={{ fontFamily: "Poppins" }}
                />
              </li>
            </ul>
